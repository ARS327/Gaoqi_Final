...
function selectorQuiz() {
    ...
    this.startGame = function () {
        ...
        listElements = [];
        usedElements = [];
        beginText = "Find me, bro";
        correctText = "Correct!";
        wrongText = "Nahhh bro";
        currentTargetText = "(~o￣▽￣)ψ Go find: ";
        gameOverText = "YOU ARE OUT ٩̋(๑˃́ꇴ˂̀๑)";
        gameEndText = "You got them all (๑˃̶͈̀ ꇴ ˂̶͈́)";
        finalScoreText = "One more time, bro?";
    ...
    this.updateScoreDisplay = function () {
        console.log(listElements);
            $('#scoreDisplay').html("Score: " + 100- listElements.length-health);
        }
